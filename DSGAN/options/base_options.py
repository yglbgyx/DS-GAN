...
class BaseOptions():
    ...
    def initialize(self, parser):
        # parser.add_argument('--dataroot',required=True,type=str,default='/home/admin1325/PycharmProjects/pythonProject',
        #                     help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        parser.add_argument('--dataroot',type=str,default='/root/dataset/256x256',
                            help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        # parser.add_argument("--nir_train_data_path2", default='E:/data/KAIST/train_NIR1',
        #                     help="path of nir training datas.")  # nir域的训练图片路径
        # parser.add_argument("--rgb_train_data_path2", default='E:/data/KAIST/train_RGB1',
        #                     help="path of rgb training datas.")  # rgb域的训练图片路径
        ...
        parser.add_argument('--which_model_netG', type=str, default='MixConvNeXtML', help='selects model to use for netG') #原本是gll
        ...
        parser.add_argument('--model', type=str, default='pix2pix',
                            help='chooses which model to use. cycle_gan, pix2pix, test,d3')
        ...
        parser.add_argument('--w_gan', default=0.01, help='weight of the gan loss')
    ...
    def parse(self,dataset_path, path):

        opt = self.gather_options()
        opt.isTrain = self.isTrain  # train or test
        opt.checkpoints_dir = os.path.join(path, 'checkpoints')
