...
class ConvNeXtML(nn.Module):
    def __init__(self):
        super(ConvNeXtML, self).__init__()
    ...
    def forward(self, x):
        ...
        O1 = self.uc1(self.u1(R5, self.mid512(R4)))
        # 256 * 64 * 64
        O2 = self.uc2(self.u2(O1, self.mid256(R3)))
        # 128 * 128 * 128
        O3 = self.uc3(self.u3(O2, self.mid128(R2)))
        # 64 * 256 * 256
        O4 = self.uc4(self.u4(O3, self.mid64(R1)))
