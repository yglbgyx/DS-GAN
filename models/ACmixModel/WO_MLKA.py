...
class WO_MLKA(nn.Module):
    def __init__(self, planes, norm_layer=nn.InstanceNorm2d):
        super(WO_MLKA, self).__init__()
...
class OriginMLKA(nn.Module):
    def __init__(self):
        ...
        self.upc2 = WO_MLKA(128)

        self.up3 = upSample(128, 64)
        self.upc3 = WO_MLKA(128)
...
class DSGAN_WO_MLKA(nn.Module):
    def __init__(self):
        super(DSGAN_WO_MLKA, self).__init__()
